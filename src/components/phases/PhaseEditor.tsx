    ...
    <Sheet open={open} onClose={onClose}>
      ...
      {phase?.autoGenerated && view === 'edit' && (
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md text-xs text-blue-800">
          Auto-generated from <strong>{familyMembers?.find((m) => m.id === phase.familyMemberId)?.name ?? 'family member'}</strong>'s longevity data. Editing will remove auto-update — this phase won't be regenerated when the family member is updated.
        </div>
      )}
